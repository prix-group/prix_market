  ...
  return (
    <section className={styles['strategy']}>
      ...
      <ul className={styles['strategy__info']}>
        ...
        <li className={styles['strategy__info-item']}>
          <span className={styles['strategy__info-item-title']}>starting from 2.5 million sum</span>
          <span className={styles['strategy__info-item-subtitle']}>follow-on investments</span>
        </li>
        <li className={styles['strategy__info-item']}>
          <span className={styles['strategy__info-item-title']}>starting from 2.5 million sum</span>
          <span className={styles['strategy__info-item-subtitle']}>follow-on investments</span>
        ...
        <li className={styles['strategy__info-item']}>
          <span className={styles['strategy__info-item-title']}>from 100k sum</span>
          <span className={styles['strategy__info-item-subtitle']}>follow-on investments</span>
        </li>
        <li className={styles['strategy__info-item']}>
          <span className={styles['strategy__info-item-title']}>starting from 2.5 million sum</span>
