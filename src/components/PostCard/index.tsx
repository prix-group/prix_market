...
export const PostCard: FC<IPost> = ({ image, title, date, major }) => {
  return (
    <div className={cn(styles['post'], { [styles['post--major']]: major })}>
      <div
      ...
      >
        <img
          className={cn(styles['image'], { [styles['image--major']]: major })}
          src={image}
          alt={'post pic'}
        />
      </div>
      <h2 className={cn(styles['title'], { [styles['title--major']]: major })}>
        {title}
      </h2>
      <div
      ...
      >
        <p className={cn(styles['date'], { [styles['date--major']]: major })}>
          {date}
        </p>
        <BlogTag />
      </div>
